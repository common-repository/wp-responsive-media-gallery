...
if(!empty($arrgalleryRecords->posts)){
	...
	$content .='<div class="rmg_wrap">
					<div class="gallery-plugin mosaic-layout">
					<div class="gallery-outer magnific-all popup-gallery">
		...
		jQuery(document).ready(function(){
			...
			jQuery("#loading").click(function(){
					...
					jQuery.ajax({
						...
						data: {"layout":"mosaic","load_more":loadmore,"postId":postId,"galleryCategoryName":galleryCategoryName,"action":"load_more_images_mosaic","ajax_nonce":ajax_nonce,"loadmoreitem":loadmoreitem},
						success: function(data){
							
							loadmore= loadmore + loadmoreitem;
							jQuery("#mosaic").append(data);
